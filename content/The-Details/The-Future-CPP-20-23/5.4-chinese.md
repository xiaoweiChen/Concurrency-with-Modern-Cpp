...
现在，valid和ready的区别就非常自然了。如果有一个数据通道的promise，则future的状态时valid。如果promise已经将其结果放入数据通道中，则future的状态是ready。
...
[提案1054R0]( http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p1054r0.html)中为未来留下了几个坑。
